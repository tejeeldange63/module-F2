...
function submitFormInfoFunction() {
    ...
    if (name && userName && email) {
        ...
        alert('Submitted successfully! Click on the next image to view your information')
...
function diceClick() {
    ...
    if (RemainingDiceClick === 0) {
        ...
        if (totalScore > 10) {
            ...
            if (attempt != 0) {
                // document.getElementById('score').innerText = totalScore;
                alert(`Sorry....!! Your total score is ${totalScore} which is less than 10. Try once again!!`);
                document.getElementById("img-3").disabled = false;
